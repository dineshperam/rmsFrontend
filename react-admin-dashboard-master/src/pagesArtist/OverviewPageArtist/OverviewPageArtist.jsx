        ...
        const fetchStats = async () => {
          try {
            const [mySongs, myRevenue, myStreams] = await Promise.all([
              axios.get(`${BASE_URL}/mysongs/${userId}`,{headers: ApiService.getHeader(),}),
              axios.get(`${BASE_URL}/totalRevenuebyId/${userId}`,{headers: ApiService.getHeader(),}),
              axios.get(`${BASE_URL}/totalStreamsById/${userId}`,{headers: ApiService.getHeader(),}),{
